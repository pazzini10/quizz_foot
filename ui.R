  ...
  fluidRow(
    column(7,box(width=12,title = "Questions", status = "primary", solidHeader = TRUE,
           div(
             ...
             selectInput("q8", "Quel est le seul grand club a donné de l'argent à son sponsor principal présent sur son maillot ? (2 millions d'euros)",
             ...
             selectInput("q12", "Quel est le seul et unique joueur à avoir réussi un quintuple en phase finale de LDC. C'était contre le Bayer Leverkusen pour une victoire 7-1",
                         c("",  "Ronaldo C.", "Adriano", "Klose","lewandowski","Messi","Neymar")),
             ...
             selectInput("q18", "Depuis les années 1990, quel est le joueur avec le meilleur ratio but par match (0.69) en Premier League (100 matchs min.) ?",
             ...
             selectInput("q23", "Quel nouveau record a été établi lors de la coupe du monde 2018? Le précédent record datait de 1998. Coincidence ?",
                         c("",  "Le plus de matchs nuls", "Le plus de buts contre son camp", "Le plus de pénalties","Le plus de cartons rouges")),
